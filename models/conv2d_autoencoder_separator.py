...
class AutoencoderConv2d:
    ...
    def get_model(self, name='autoencoder_spectrogram'):
        ...
        conv1 = keras.layers.Conv2D(32, (31, 3), padding='same', activation='relu')(reshaped_input)
        ...
        conv2 = keras.layers.Conv2D(64, (31, 3), padding='same', activation='relu')(bn1)
        downsample2 = keras.layers.Conv2D(64, (31, 3), strides=(2, 2), padding='same',
                                          activation='relu', use_bias=False)(conv2)
        bn2 = keras.layers.BatchNormalization()(downsample2)

        # 3rd conv + batch normalization
        conv3 = keras.layers.Conv2D(128, (31, 3), padding='same', activation='relu', use_bias=False)(bn2)
        ...
        conv4 = keras.layers.Conv2D(64, (31, 3), padding='same', activation='relu')(
        ...
        conv5 = keras.layers.Conv2D(32, (31, 3), padding='same', activation='relu')(
            keras.layers.concatenate([conv1, up2_fixed_shape]))
        bn5 = keras.layers.BatchNormalization()(conv5)

        # output layers
        x = keras.layers.Conv2D(32, (31, 3), padding='same', activation='relu')(bn5)
