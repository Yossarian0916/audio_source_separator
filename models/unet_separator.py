...
class UnetSeparator:
    ...
    def get_model(self, name='unet_separator'):
        ...
        vocals = self.conv1d_bn(vocals_input, self.frames, 15)
        bass = self.conv1d_bn(bass_input, self.frames, 15)
        drums = self.conv1d_bn(drums_input, self.frames, 3)
        other = self.conv1d_bn(other_input, self.frames, 7)
